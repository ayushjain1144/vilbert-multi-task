...
# python convert_to_lmdb_referit.py --features_dir output/ --lmdb_file lmdb/referit.lmdb
...
if __name__ == "__main__":
    ...
    with env.begin(write=True) as txn:
        for infile in tqdm.tqdm(infiles):
            ...
            item['object_classes'] = reader.item().get("objects")
            item['obj_pc'] = reader.item().get("obj_pc")
            item['color_pc'] = reader.item().get("color_pc")
